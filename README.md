...
**Краткий ответ:**
### Наивная рекурсия Фибоначчи неэффективна из-за экспоненциального роста повторяющихся вычислений. Одна и та же подзадача вычисляется многократно, что приводит к временной сложности O(2ⁿ) вместо оптимальной O(n).
